CREATE TEMPORARY VIEW class_112 AS (
    ...
    CASE
        ...
        THEN ROW(
            ...
            ARRAY_TO_STRING(
                ARRAY_REMOVE(
                    ARRAY[
                        pan_nz_draft_iucn_Ib.designation,
                        NULLIF(CONCAT_WS(' ', pan_nz_draft_iucn_Ib.legislation_act, pan_nz_draft_iucn_Ib.legislation_section), ''),
    ...
    JOIN (
        ...
        ORDER BY
            ...
            source_id -- Tie-break
    ) pan_nz_draft_iucn_Ib ON roi.h3_index && pan_nz_draft_iucn_Ib.h3_index
)