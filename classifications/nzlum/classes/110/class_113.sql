CREATE TEMPORARY VIEW class_113 AS (
    SELECT roi.h3_index,
    1 AS lu_code_primary,
    1 AS lu_code_secondary,
    3 AS lu_code_tertiary,
    CASE
        WHEN pan_nz_draft_iucn_II.h3_index IS NOT NULL
        THEN ROW(
            ...
            ARRAY_TO_STRING(
                ARRAY_REMOVE(
                    ARRAY[
                        ...
                        NULLIF(CONCAT_WS(' ', pan_nz_draft_iucn_II.legislation_act, pan_nz_draft_iucn_II.legislation_section), ''),
    ...
    JOIN (
        ...
        ORDER BY
            ...
            source_id -- Tie-break
    ) pan_nz_draft_iucn_II ON roi.h3_index && pan_nz_draft_iucn_II.h3_index
)